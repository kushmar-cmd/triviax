...
async def generate_question(cat: str, difficulty: str, asked: list = None) -> dict:
    ...
    prompt = (
        ...
        "כללי אמינות — חובה לעמוד בהם:\n"
        "1. השתמש רק בעובדות שאתה בטוח בהן 100%. אל תנחש לעולם.\n"
        "2. אל תמציא שמות של אנשים, להקות, שירים, סרטים, קבוצות ספורט, תאריכים.\n"
        "3. אם אינך בטוח בעובדה — בחר נושא אחר שאתה בטוח בו במקום.\n"
        "4. כל 4 האפשרויות חייבות להיות אמיתיות ומוכרות — לא שמות מומצאים.\n"
        "5. עדיף שאלה פשוטה ומדויקת על פני שאלה מעניינת שאינה מדויקת.\n\n"
